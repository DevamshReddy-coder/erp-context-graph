...
export async function POST(req: Request) {
  try {
    ...
    // --- ANALYTICAL HARD-PLEDGE (V4.3 FINAL) ---
    if ((lowerQuery.includes("trace") || lowerQuery.includes("journey")) && /\d+/.test(lowerQuery)) {
        ...
        offlineOverrideText = `🛡️ **V4.3 ANOMALY DETECTOR**: Analyzed global context for O2C flow leakage.\n\nI have identified **high-risk Sales Orders** that were delivered but remain **unbilled**. This represents structural revenue leakage. [V4.3 FINAL]`;
        parsed = {
